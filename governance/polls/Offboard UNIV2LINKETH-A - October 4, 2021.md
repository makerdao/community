...
summary: Signal your support or opposition to offboard the UNIV2LINKETH-A vault type.
...
---
# Poll: Offboard the UNIV2LINKETH-A Vault Type - October 4, 2021
...
* Increase the UNIV2LINKETH-A [Liquidation Ratio](https://makerdao.world/en/learn/governance/param-liquidation-ratio/) over 60 days using dss-lerp such that all vaults are liquidated by the end of that period.
