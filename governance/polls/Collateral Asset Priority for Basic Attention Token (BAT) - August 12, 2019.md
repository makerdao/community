...
In this poll, voters are able to signal their level of support for **Basic Attention Token (BAT)**. The total amount of MKR staked in the 'Yes' option for this asset will raise it up the evaluation priority list, the total MKR staked on the 'No' option will lower it.
