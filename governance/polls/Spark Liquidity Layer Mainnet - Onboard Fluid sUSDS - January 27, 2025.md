---
title: Spark Liquidity Layer Mainnet - Onboard Fluid sUSDS - January 27, 2025
summary: Signal your support or opposition to onboarding Fluid sUSDS to the Spark Liquidity Layer on mainnet.
...
---
# Poll: Spark Liquidity Layer Mainnet - Onboard Fluid sUSDS - January 27, 2025
...
The community can vote in this poll to express support or opposition to onboarding Fluid sUSDS to the Spark Liquidity Layer on Mainnet with the following [rate limits](https://docs.spark.fi/dev/spark-liquidity-layer/spark-alm-controller#rate-limits):
