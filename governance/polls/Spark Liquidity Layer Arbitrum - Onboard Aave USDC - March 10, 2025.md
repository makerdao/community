---
title: Spark Liquidity Layer Arbitrum - Onboard Aave USDC - March 10, 2025
summary: Signal your support or opposition to onboarding Aave USDC onto the Spark Liquidity Layer on Arbitrum.
...
---
# Poll: Spark Liquidity Layer Arbitrum - Onboard Aave USDC - March 10, 2025
...
The community can vote in this poll to express support or opposition to onboarding Aave USDC onto the Spark Liquidity Layer on Arbitrum with the following [Rate Limits](https://docs.spark.fi/dev/spark-liquidity-layer/spark-alm-controller#rate-limits):
