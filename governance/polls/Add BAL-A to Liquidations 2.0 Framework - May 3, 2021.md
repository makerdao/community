---
title: Add BAL-A to Liquidations 2.0 Framework - May 3, 2021
summary: This poll proposes system parameters which could be used to initialize BAL-A with the Liquidations 2.0 Framework.
...
options:
   ...
   2: No
---
# Poll: Add BAL-A to Liquidations 2.0 Framework - May 3, 2021
...
This poll allows the MakerDAO governance community to signal their support or opposition to adding BAL-A to the Liquidations 2.0 Framework in the Maker Protocol with the parameters below:
...
Please review the following [Risk Evaluation](https://forum.makerdao.com/t/remaining-vaults-liquidations-2-0-parameters/7753) containing information about BAL-A to inform your position before voting.

## Outcomes

**If the votes for the 'Yes' option exceed the votes for the 'No' option, then the following actions will be taken:**
* BAL-A will be added to the Liquidations 2.0 System by a future executive vote as the Smart Contracts Team schedule allows. 
