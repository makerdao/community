---
title: Community Greenlight Poll - PUNK (CryptoPunk) - February 21, 2022
summary: Signal your support or opposition to prioritising onboarding PUNK (CryptoPunk).
...
* The 'greenlight score' will be calculated for PUNK (CryptoPunk) using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for PUNK (CryptoPunk) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitators.
