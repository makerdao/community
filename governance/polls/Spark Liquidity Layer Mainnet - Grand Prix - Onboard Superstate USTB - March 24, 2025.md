---
title: Spark Liquidity Layer Mainnet - Grand Prix - Onboard Superstate USTB - March 24, 2025
summary: Signal your support or opposition to onboarding Superstate USTB to the Spark Liquidity Layer.
...
---
# Poll: Spark Liquidity Layer Mainnet - Grand Prix - Onboard Superstate USTB - March 24, 2025
...
The community can vote in this poll to express support or opposition to onboarding Superstate USTB to the Spark Liquidity Layer on mainnet with the following [rate limits](https://docs.spark.fi/dev/spark-liquidity-layer/spark-alm-controller#rate-limits):
