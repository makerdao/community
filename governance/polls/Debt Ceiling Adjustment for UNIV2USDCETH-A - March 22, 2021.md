---
title: Increase Debt Ceiling and add DC-IAM for UNIV2USDCETH-A - March 22, 2021
summary: Signal your support or opposition for adjusting the UNIV2USDCETH-A Debt Ceiling from 3 million DAI to 50 million DAI and adding DC-IAM for UNIV2USDCETH-A.
...
options:
   ...
   2: No
---
# Poll: Increase Debt Ceiling and add DC-IAM for UNIV2USDCETH-A - March 22, 2021
...
* Increase Debt Ceiling for UNIV2USDCETH-A from 3 million DAI to 50 million DAI.
* Deploy a Debt Ceiling Instant Access Module (DC-IAM) for UNIV2USDCETH-A with the following parameters:
    * `ttl` = 12h
    * `gap` = 5m
