---
title: Add RWA-009 (HVBank) as a new Vault Type - July 4, 2022
summary: This poll proposes system parameters which could be used to initialize RWA-009 (HVBank) as a new RWA vault type.
...
This poll allows the MakerDAO governance community to signal their support or opposition to adding RWA-009 (HVBank) as a new vault type in the Maker Protocol with the parameters below:
...
A number of legal agreements are executed in advance of the Governance Poll - see [details](https://forum.makerdao.com/t/huntingdon-valley-bank-transaction-documents-on-permaweb/16264) - and are a necessary precondition to finalization of the definitive transaction agreements. The other transaction agreements will be executed subsequent to the Governance Poll but prior to the Executive Spell should the Governance Poll have a positive outcome (i.e. if votes for "Yes" exceed votes for "No").

## Outcomes

**If the votes for the 'Yes' option exceed the votes for the 'No' option then the following actions will be taken:**
* RWA-009 (HVBank) will be onboarded in a future executive vote as the Protocol Engineering Core Unit's schedule allows.
