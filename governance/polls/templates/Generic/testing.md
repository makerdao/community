---
title: Activate the Governance Security Module - Oct 7, 2022
...
options:
   ...
   2: No
---
# Poll: Activate the Governance Security Module - Oct 7, 2022

The Maker Foundation Interim Risk Team has placed a Governance Poll into the [voting system](https://vote-dev.gsuprotocol.io/) which the community can use to activate the [Governance Security Module](https://docs.makerdao.com/smart-contract-modules/governance-module/pause-detailed-documentation#1-introduction-summary).
