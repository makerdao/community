...
The community can vote in this poll to express support or opposition to modifying the [Debt Floor](https://manual.makerdao.com/parameter-index/vault-risk/param-debt-floor?q=gsm) (also known as Dust) parameter for most vault-types:
...
* This change will be included in the weekly Executive Vote following the conclusion of this poll.
...
Unsure about the Debt Floor (dust) parameter and what you should take into account when voting? Check out the parameter documentation [here](https://manual.makerdao.com/parameter-index/vault-risk/param-debt-floor?q=gsm).
