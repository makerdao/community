...
Supply caps limit the Facilitators' ability to mint more DAI into the market. The Morpho Spark DAI vault recently filled the existing 50 million DAI supply cap for the sUSDe 91.5% LLTV pool. Given Ethena’s recent change in sUSDe rate calculations, which resulted in increased yield and collateral demand, Phoenix Labs and [BA Labs](https://forum.makerdao.com/t/may-21-2024-proposed-changes-to-sparklend-for-upcoming-spell/24327/2) recommend increasing the allocation to the sUSDe 91.5% and 86% LLTV pools over time. 
The community can vote in this poll to express support or opposition to the following changes to SparkLend on Ethereum mainnet:
