...
Please review the following forum threads containing information about SLP-USDC-ETH and the underlying collateral USDC-ETH to inform your position before voting.
...
* SLP-USDC-ETH (Sushiswap USDC-ETH LP) will be onboarded in a future executive vote as the Protocol Engineering Core Unit's schedule allows. 
