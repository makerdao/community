...
The community can vote in this poll to express support or opposition to appending Oasis.app to the rETHUSD Oracle Security Module whitelist to read current and queued price data.

Please review the application [thread](https://forum.makerdao.com/t/mip10c9-sp31-proposal-to-whitelist-oasis-app-on-rethusd-oracle/18195) to inform your position on this issue before voting.
...
Additional information about the MIPs process can be found in the [MIPs Portal)](https://mips.makerdao.com/).
