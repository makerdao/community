---
title: Community Greenlight Poll - aUST (Anchor TerraUSD) - December 06, 2021
summary: Signal your support or opposition to prioritising onboarding aUST (Anchor TerraUSD). 
...
---
# Poll: Community Greenlight Poll - aUST (Anchor TerraUSD) - December 06, 2021
...
This poll asks whether the asset aUST (Anchor TerraUSD) should be prioritized for inclusion in the Maker Protocol by the [Core Units](https://mips.makerdao.com/mips/details/MIP38#mip38c2-core-unit-state). 
...
* The 'greenlight score' will be calculated for aUST (Anchor TerraUSD) using the formula `Score = 'Yes' Votes - 'No' Votes`
