---
title: Community Greenlight Poll - OFH (Security Tokens Refinancing) - October 18, 2021
summary: Signal your support or opposition to prioritising onboarding OFH (Security Tokens Refinancing). 
...
This poll asks whether the asset OFH (Security Tokens Refinancing) should be prioritized for inclusion in the Maker Protocol by the [Core Units](https://mips.makerdao.com/mips/details/MIP38#mip38c2-core-unit-state). 

Please review the collateral onboarding application [thread](https://forum.makerdao.com/t/security-tokens-refinancing-mip6-application-for-ofh-tokens/10605) to inform your position before voting.

## Outcomes

**Regardless of the winning option the following actions will be taken at the conclusion of this poll:**
* The 'greenlight score' will be calculated for OFH (Security Tokens Refinancing) using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for OFH (Security Tokens Refinancing) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitators.
