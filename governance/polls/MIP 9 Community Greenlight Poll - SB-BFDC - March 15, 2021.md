---
title: Community Greenlight Poll - SB-BFDC (SolidBlock BeachFront Digital Coin) - March 15, 2021
summary: Signal your support or opposition to prioritising onboarding SB-BFDC (SolidBlock BeachFront Digital Coin). 
...
options:
   ...
   2: No (Defer)
---
# Poll: Community Greenlight Poll - SB-BFDC (SolidBlock BeachFront Digital Coin) - March 15, 2021
...
This poll asks whether the asset SB-BFDC (SolidBlock BeachFront Digital Coin) should be prioritized for inclusion in the Maker Protocol by the [domain teams](https://github.com/makerdao/mips/blob/master/MIP7/mip7.md#mip7c2-the-current-domain-roles-list). 
...
* The 'greenlight score' will be calculated for SB-BFDC (SolidBlock BeachFront Digital Coin) using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for SB-BFDC (SolidBlock BeachFront Digital Coin) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitator(s).
