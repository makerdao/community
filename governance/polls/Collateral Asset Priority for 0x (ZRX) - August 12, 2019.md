---
title: Collateral Asset Priority for 0x (ZRX) - August 12, 2019
...
options:
   ...
   2: No
---
# Poll: Collateral Asset Priority for 0x (ZRX) - August 12, 2019
...
In this poll, voters are able to signal their level of support for **0x (ZRX)**. The total amount of MKR staked in the 'Yes' option for this asset will raise it up the evaluation priority list, the total MKR staked on the 'No' option will lower it.
