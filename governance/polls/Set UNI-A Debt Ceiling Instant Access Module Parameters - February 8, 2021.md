---
title: Set UNI-A Debt Ceiling Instant Access Module Parameters - February 8, 2021
summary: Signal your support or opposition to using the Debt Ceiling Instant Access Module for UNI-A with the listed parameters.
...
options:
   ...
   2: No
---
# Poll: Set UNI-A Debt Ceiling Instant Access Module Parameters - February 8, 2021

The Governance Facilitators have placed a Governance Poll into the voting system on behalf of the MakerDAO Risk Domain Team. The community can vote in this poll to express support or opposition to using the Debt Ceiling Instant Access Module for UNI-A with the listed parameters.
...
The proposed parameters for the UNI-A Debt Ceiling Instant Access Module are:
* Collateral Type (`ilk`): UNI-A
