---
title: Offboard the COMP-A Vault Type - November 15, 2021
summary: Signal your support or opposition to offboard the COMP-A vault type.
...
---
# Poll: Offboard the COMP-A Vault Type - November 15, 2021
...
* Lower the COMP-A [Liquidation Penalty (chop)](https://makerdao.world/en/learn/governance/param-liquidation-penalty/) to 0%.
* Lower the COMP-A [Debt Ceiling (line)](https://makerdao.world/en/learn/governance/param-debt-ceiling) to 0 DAI.
* Increase the COMP-A [Liquidation Ratio](https://makerdao.world/en/learn/governance/param-liquidation-ratio/) over 60 days using dss-lerp such that all vaults are liquidated by the end of that period.
