...
summary: Signal your support or opposition to prioritising onboarding RBLD (Robinland Holdings). 
discussion_link: https://forum.makerdao.com/t/rbld-mip6-collateral-onboarding-application-real-estate-new/11911
...
This poll asks whether the asset RBLD (Robinland Holdings) should be prioritized for inclusion in the Maker Protocol by the [Core Units](https://mips.makerdao.com/mips/details/MIP38#mip38c2-core-unit-state). 

Please review the collateral onboarding application [thread](https://forum.makerdao.com/t/rbld-mip6-collateral-onboarding-application-real-estate-new/11911) to inform your position before voting.

## Outcomes

**Regardless of the winning option the following actions will be taken at the conclusion of this poll:**
* The 'greenlight score' will be calculated for RBLD (Robinland Holdings) using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for RBLD (Robinland Holdings) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitators.
