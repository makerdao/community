---
title: Community Greenlight Poll - SB-LDB (SolidBlock London Digital Bonds) - February 15, 2021
summary: Signal your support or opposition to prioritising onboarding SB-LDB (SolidBlock London Digital Bonds). 
discussion_link: https://forum.makerdao.com/t/sb-ldb-mip6-application-solidblock-democratizes-real-estate-with-london-digital-bonds-a-smart-tradable-property-investment/6276
...
options:
   ...
   2: No (Defer)
---
# Poll: Community Greenlight Poll - SB-LDB (SolidBlock London Digital Bonds) - February 15, 2021
...
* The 'greenlight score' will be calculated for SB-LDB (SolidBlock London Digital Bonds) using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for SB-LDB (SolidBlock London Digital Bonds) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitator(s).
