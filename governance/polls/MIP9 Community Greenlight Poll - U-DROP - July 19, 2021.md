---
title: Community Greenlight Poll - Untangled Finance DROP (U-DROP) - July 19, 2021
summary: Signal your support or opposition to prioritising onboarding Untangled Finance DROP (U-DROP). 
...
options:
   ...
   1: Yes (Greenlight)
   2: No (Defer)
start_date: 2021-07-19, 16:00:00
end_date: 2021-08-02, 16:00:00
---
# Poll: Community Greenlight Poll - Untangled Finance DROP (U-DROP) - July 19, 2021
...
This poll asks whether the asset Untangled Finance DROP (U-DROP) should be prioritized for inclusion in the Maker Protocol by the [Core Units](https://mips.makerdao.com/mips/details/MIP38#mip38c2-core-unit-state). 
...
* The 'greenlight score' will be calculated for Untangled Finance DROP (U-DROP)using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for Untangled Finance DROP (U-DROP) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitators.
