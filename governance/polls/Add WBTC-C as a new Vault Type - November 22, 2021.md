---
title: Add WBTC-C as a new Vault Type - November 22, 2021
summary: This poll proposes system parameters which could be used to initialize WBTC-C as a new vault type.
discussion_link: https://forum.makerdao.com/t/signal-request-new-vault-type-for-wbtc-with-a-higher-lr/11579
...
---
# Poll: Add WBTC-C as a new Vault Type - November 22, 2021
...
This poll allows the MakerDAO governance community to signal their support or opposition to adding WBTC-C as a new vault type in the Maker Protocol with the parameters below:
...
* WBTC-C will be onboarded in a future executive vote as the Protocol Engineering Core Unit's schedule allows. 
