...
# Poll: Collateral Asset Priority for OmiseGo (OMG) - August 12, 2019
...
In this poll, voters are able to signal their level of support for **OmiseGo (OMG)**. The total amount of MKR staked in the 'Yes' option for this asset will raise it up the evaluation priority list, the total MKR staked on the 'No' option will lower it.
