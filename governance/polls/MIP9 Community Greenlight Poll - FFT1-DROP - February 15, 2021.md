---
title: Community Greenlight Poll - FFT1-DROP (Fortunafi DROP) - February 15, 2021
summary: Signal your support or opposition to prioritising onboarding FFT1-DROP (Fortunafi DROP). 
...
options:
   ...
   2: No (Defer)
---   
# Poll: Community Greenlight Poll - FFT1-DROP (Fortunafi DROP) - February 15, 2021
...
* The 'greenlight score' will be calculated for FFT1-DROP (Fortunafi DROP) using the formula `Score = 'Yes' Votes - 'No' Votes`
* The 'greenlight score' for FFT1-DROP (Fortunafi DROP) will be added to the [Collateral Prioritisation Sheet](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) by the Governance Facilitator(s).
