---
title: Add CurveLP-stETH-ETH as a new Vault Type - November 29, 2021
summary: This poll proposes system parameters which could be used to initialize CurveLP-stETH-ETH as a new vault type.
...
---
# Poll: Add CurveLP-stETH-ETH as a new Vault Type - November 29, 2021
...
This poll allows the MakerDAO governance community to signal their support or opposition to adding CurveLP-stETH-ETH (Curve Lido Staked ETH Liquidity Pool Token) as a new vault type in the Maker Protocol with the parameters below:

### Initial Collateral Parameters

* Underlying Collateral: CurveLP-stETH-ETH
* [Stability Fee](https://community-development.makerdao.com/en/learn/governance/param-stability-fee): 4.5%
* [Liquidation Ratio](https://community-development.makerdao.com/en/learn/governance/param-liquidation-ratio): 155%
...
* [Auction Price Function (`calc`)](https://community-development.makerdao.com/en/learn/governance/param-auction-price-function): Stairstep Exponential Decrease
...
* [Auction Price Multiplier (`buf`)](https://community-development.makerdao.com/en/learn/governance/param-auction-price-multiplier): 1.30
...
Please review the following forum threads containing information about CurveLP-stETH-ETH (Curve Lido Staked ETH Liquidity Pool Token) to inform your position before voting.
* [Proposal Thread](https://forum.makerdao.com/t/curvelp-steth-eth-mip6-collateral-onboarding-application/10229)
* [Risk Core Unit Evaluation](https://forum.makerdao.com/t/curvelp-steth-eth-collateral-onboarding-risk-evaluation/11224)
* [Protocol Engineering Core Unit Evaluation](https://forum.makerdao.com/t/curve-fi-eth-steth-erc20-token-smart-contract-technical-assessment/11855)
...
* CurveLP-stETH-ETH (Curve Lido Staked ETH Liquidity Pool Token) will be onboarded in a future executive vote as the Protocol Engineering Core Unit's schedule allows. 
