...
- The `receiver` will be set to the Pause Proxy address - `0xdbbe5e9b1daa91430cf0772fcebe53f6c6f137df `. The `receiver` is the address that LP tokens will be deposited to after each market action.
