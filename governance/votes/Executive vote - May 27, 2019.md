---
title: Signal your support to set the Stability Fee to 21.5%
summary: Vote for this proposal to set the Stability Fee to 21.5% per year
date: 2019-05-27T00:00:00.000Z
address: "0xAc4b4DAeCbf1aA49D647e8B4f98816DB6745254f"
---
The Maker Foundation Interim Risk Team has placed a Governance Poll into the [voting system](https://vote.makerdao.com/polling) which presents a number of possible Dai Stability Fee options. Voters are now able to signal their support for a Stability Fee within a range of 13.50% to 23.50%.

This Governance Poll ([FAQ](https://makerdao.com/en/faq/voting#what-is-governance-voting)) will be active for three days beginning on Monday, May 27 at 4 PM UTC, the results of which will inform an Executive Vote ([FAQ](https://makerdao.com/en/faq/voting#what-is-executive-voting)) which will go live on Friday, May 31, at 4 PM UTC.

## Review
The Stability Fee was discussed in the Governance call on Thursday, May 23. Please review the [Video](https://www.youtube.com/playlist?list=PLLzkWCj8ywWNq5-90-Id6VPSsrk4OWVan), [Audio](https://soundcloud.com/makerdao/sets/governance-and-risk), [Transcript](https://github.com/makerdao/community/tree/master/governance/transcripts) and the online [discussion](https://www.reddit.com/r/mkrgov/) to inform your position before voting.

## Action
**Vote for this proposal to signal your support to set the Stability Fee to  21.5% per year.**
