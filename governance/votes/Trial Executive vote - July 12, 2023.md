...
**! Unconfirmed** - **Documentation and context still required**

- Add multiswap at xxx as RWA015_A_OUTPUT_CONDUIT
- Deauth operator on old output conduit
- Remove RWA015_A_OUTPUT_CONDUIT_LEGACY from the chainlog
...
Furthermore, the following stability scope changes will be made:
