---
title: Template - [Executive Vote] Recognized Delegate Compensation, GNO Onboarding, Real World Asset Vaults Onboarding, renBTC-A Offboarding, Tech-Ops MKR Stream, and Parameter Changes - December 09, 2022
summary: Recognized Delegate Compensation for November 2022, Onboarding GNO-A (GnosisDAO), Onboarding Real World Asset Vaults Multiple BlockTower Credit Vault Types (RWA010, RWA011, RWA012, RWA013), Offboarding renBTC-A (renBTC), MKR stream for Tech-Ops (TECH-001), MOMC parameter changes, and DAI Savings Rate Adjustment.
date: 2022-12-09T00:00:00.000Z
address: "$spell_address"

---
# [Executive Proposal] Recognized Delegate Compensation, GNO Onboarding, Real World Asset Vaults Onboarding, renBTC-A Offboarding, Tech-Ops MKR Stream, and Parameter Changes - December 09, 2022
...
- A total of **$xxxxxx DAI** will be distributed to $xx Recognized Delegates as itemized below.
- renBTC-A will be offboarded, as detailed below.
- A total of **257.31 MKR** will be transferred to the [Tech-Ops (TECH-001)](https://mips.makerdao.com/mips/details/MIP39c2SP29), as detailed below.
- Parameter changes from the latest proposal from the MakerDAO Open Market Committee: multiple [Debt Ceiling](https://manual.makerdao.com/parameter-index/vault-risk/param-debt-ceiling) changes, multiple [Target Available Debt](https://manual.makerdao.com/module-index/module-dciam#target-available-debt-gap) reductions, multiple [Ceiling Increase Cooldown](https://manual.makerdao.com/module-index/module-dciam#ceiling-increase-cooldown-ttl) increases, and [Peg Stability Module (PSM)](https://manual.makerdao.com/module-index/module-psm) fee changes, as detailed below.
- DSR

If this executive proposal passes, the following **additions** will be made to the Maker Protocol:
- GNO-A (GnosisDAO) will be onboarded to the protocol with the initial parameters detailed below.
- Multiple BlockTower Credit Vault Types will be onboarded to the protocol with the respective initial parameters as detailed below.
...
As per [this poll](https://vote.makerdao.com/polling/QmNucsGt) multiple vault types with BlockTower Credit as the arranger with the parameters below, if this executive proposal passes.
...
As per [this poll](https://vote.makerdao.com/polling/QmTNMDfb), the following parameters changes will occur to offboard renBTC-A if this executive proposal passes:
...
- Lower the [Local Liquidation Limit (`hole`)](https://manual.makerdao.com/parameter-index/collateral-auction/param-local-liquidation-limit) to 350,000 DAI.
