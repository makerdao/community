...
[https://youtu.be/JC2rr95pK-8](https://youtu.be/JC2rr95pK-8)

### Terms

`ES`: Emergency Shutdown `SF`: Stability Fee `SLP`: Secondary Lending Platform `DSR`: Dai Savings Rate
...
* [23:22](https://youtu.be/JC2rr95pK-8?t=1404): Chris:
  ...
  * 1. A lot of my time is spent on social media, I don't think it's realistic to shelter Maker's governance from public opinion. I think our best aim would be to educate rather than control.
