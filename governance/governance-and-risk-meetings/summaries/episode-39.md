...
* 58:06\]\([https://youtu.be/MBdpqqMZRNg?t=3486](https://youtu.be/MBdpqqMZRNg?t=3486)\): Vishesh asks, once initial modeling is done and parameters selected, how often should we reevaluate an asset?
...
#### _**Priority Topics for Discussion in the comments below**_
