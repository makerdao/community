# Encuesta: Encuesta Comunitaria de Visto Bueno **- UNI-V2-DAI-YFI (UniswapV2 DAI-YFI Liquidity Token) - 18 de enero de 2021**
...
Esta encuesta inquiere si el activo UNI-V2-DAI-YFI (UniswapV2 DAI-YFI Liquidity Token) debería priorizarse para su inclusión en el Protocolo Maker por los [equipos de dominio](https://github.com/makerdao/mips/blob/Accepted/MIP7/mip7.md#mip7c2-the-current-domain-roles-list).

Por favor revisa el [hilo](https://forum.makerdao.com/t/uni-v2-dai-yfi-mip6-collateral-onboarding-application/5606) de solicitud de incorporación de colaterales para informar tu posición antes de votar.
...
- El "puntaje de visto bueno" de UNI-V2-DAI-YFI (UniswapV2 DAI-YFI Liquidity Token) se calculará usando la fórmula `Puntaje = Votos "Sí" - Votos "No"`
- El "puntaje de visto bueno" de UNI-V2-DAI-YFI (UniswapV2 DAI-YFI Liquidity Token) será añadida a la [Hoja de Cálculo de Priorización de Colaterales](https://docs.google.com/spreadsheets/d/1IX9e2fyfz7djtDMKn5gMyGsyFxHoY75GncMbAjnSXrM/edit#gid=0) por los Facilitadores de Gobernanza.
...
Esta es una traducción libre del [artículo original en inglés](https://github.com/makerdao/community/blob/master/governance/polls/MIP9%20Community%20Greenlight%20Poll%20-%20UNI-V2-DAI-YFI%20-%20%20January%2018,%202021.md), gracias a @Blimpa y @Lozadaluis12 por la traducción.
