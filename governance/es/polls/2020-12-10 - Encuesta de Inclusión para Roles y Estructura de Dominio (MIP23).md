# Encuesta de Inclusión para Roles y Estructura de Dominio **(MIP23) - 12 de octubre de 2020**

Los Facilitadores de Gobernanza han colocado una encuesta de inclusión en el [sistema de votación](https://vote.makerdao.com/polling); esta inquiere si la propuesta (Roles y Estructura de Dominio) debería incluirse en la Encuesta de Gobernanza Mensual.
...
Para votar, visita el [artículo original aquí](https://github.com/makerdao/community/blob/master/governance/polls/Inclusion%20Poll%20-%20MIP23%20-%20October%2012,%202020.md).
