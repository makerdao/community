---
title: "Global Communities Need Translations"
authors: ["andytudhope", "twblack88", "MaximumCrash"]
date: 2021-02-19
image: "4"
---
...
Did you catch the `camlCase` joke? 
...
`t('Friend', null, {count: 1, strict: true})`. NOTE: `Friend` and `Friend_plural` are still valid, but will be overriden when strict is provided to the variables argument.
...
These are just examples for the sake of documentation. For an in-depth dive on how the function works,
see the [comments in code](https://github.com/makerdao/community/blob/r2d/src/modules/localization/useTranslation.js)
