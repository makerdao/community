...
function LinkWrapper({ ariaLabel, ...props }: TLinkWrapperProps): Node {
...
export type TIconLinkProps = { url: string, key?: string };
...
export default function IconLink({ url, key }: TIconLinkProps): Node {
