...
export default function List({ children }: TListProps): Node {
...
function ListElement({ children }: TListElementProps): Node {
  return (
    <Flex
      sx={{
        px: '8px',
...
type TAdvancedListElementProps = {
  childData: {
    heading: string,
    _children: Node,
  },
