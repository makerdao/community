...
MKR 持有者参与的最早一个投票是“[渐进式去中心化](https://medium.com/makerdao/foundation-proposal-v2-f10d8ee5fe8c)”的宪章，这是 MakerDAO 平台将如何演化的重要部分。
...
最早的例子是 [基金会提案](https://medium.com/makerdao/foundation-proposal-v2-f10d8ee5fe8c) ，这个提案建立了 MakerDAO 的五个核心原则。
...
MKR 持有者也可以对系统的运营支出进行投票，这部分资金来自整个系统的稳定费。意味着，未来 MKR 持有者可以设定 Dai [储蓄利率](https://medium.com/makerdao/dai-reward-rate-earn-a-reward-from-holding-dai-10a07f52f3cf)，并且也可以选择将部分稳定费用于支付必要的服务提供商，如预言机提供商、开发者、风险团队等。
...
如果你将热钱包连接到 [治理面板](https://vote.makerdao.com)，“投票合约”一栏将显示你的 MKR 总数。


## 如何取回我的 MKR？

想要取回锁定的 MKR，首先需要打开 [治理仪面板](https://vote.makerdao.com) 并连接热钱包，然后点击“投票合约”。在右下角，你会看到一个“从投票合约取回 MKR（Withdraw from voting contract）”的链接。单击该链接并选择您要取回的金额，然后确认交易。锁定的 MKR 只能移回你连接的冷钱包。
...
你可以选择将新 MKR 添加到您的投票合约中进行充值，只需要一笔交易即可。可以通过打开 [治理面板](https://vote.makerdao.com)，点击“投票合约”，然后点击“充值投票合同”按钮找到此选项。


## 我可以断开我冷热钱包之间的连接吗？

可以。您可以在 [治理面板](https://vote.makerdao.com) 上断开钱包间的连接。点击“投票合约”，然后点击“断开钱包连接”按钮。
