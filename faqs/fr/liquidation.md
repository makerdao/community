...
En tant que propriétaire de CDP, il est de *votre responsabilité* de vous préoccuper de la santé de votre position. Voici quelques bonnes pratiques suggérées par des utilisateurs du système:
