...
Sì. I possessori di CDP devono pagare un interesse (Stability Fee, letteralmente "tassa di stabilita") sul prestito loro concesso. Si tratta di tasso composto continuo ([APY continuously compounded rate](https://it.wikipedia.org/wiki/Tasso_d%27interesse#Montante_ad_interesse_composto_continuo_o_matematico)).
