...
- The Initial [Collateral Onboarding](risk/collateral-onboarding-guide.md) Process: this covers the trade support structure, distribution of token holdings and available data series.
