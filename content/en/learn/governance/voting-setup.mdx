...
## Vote on MakerDAO Governance

<Box sx={{ px: 4 }}>

Learn how to prepare your wallet to participate in protecting the Maker Protocol's integrity through on-chain voting.
...
Recent upgrades to the Governance Portal make it easier to vote on Governance Polls. If you hold any MKR in your wallet, you can easily voice your opinion on a poll without setting up a voting contract. Governance polls are lower stakes, and poll outcomes don't immediately impact the protocol.

To vote on a Governance Poll, navigate to the [Polling tab.](https://vote.makerdao.com/polling?network=mainnet) For each live poll, select from options available and add them to your ballet. Once satisfied, submit a transaction to cast your vote. Once the transaction confirms, your vote is registered. If you want to, you can change your vote later at any time before the poll ends.
...
Set up a Voting Contract to vote on executive proposals with MKR from a single hot wallet or a linked wallet for more security. Linked-wallet Voting Contracts let users vote from their hot wallet while their MKR remains stored on their cold wallet.
...
Guides for using other wallet types:
...
<Aligner center sx={{height: '3em', width: '65%'}}>

<Image src="/images/voter-2.png" />
...
<Aligner center sx={{height: '35%', width: '50%'}}>

<Image src="/images/voter-4.png" />
...
<Aligner center sx={{height: '100%', width: '100%'}}>

<Image src="/images/voter-7.png" />
...
<Aligner center sx={{height: '50%', width: '50%'}}>

<Image src="/images/voter-8.png" />

</Aligner>

<Aligner center sx={{height: '50%', width: '50%'}}>

<Image src="/images/voter-9.png" />
...
<Image src="/images/voter-10.png" />

</Aligner>

<Aligner center sx={{height: '50%', width: '50%'}}>

<Image src="/images/voter-11.png" />
...
<Image src="/images/voter-17.png" />

</Aligner>

<Aligner center sx={{height: '50%', width: '50%'}}>

<Image src="/images/voter-18.png" />
...
<Image src="/images/voter-19.png" />

</Aligner>

<Aligner center sx={{height: '50%', width: '50%'}}>

<Image src="/images/voter-20.png" />
...
<Image src="/images/voter-21.png" />

</Aligner>

<Aligner center sx={{height: '50%', width: '50%'}}>

<Image src="/images/voter-22.png" />
...
<Image src="/images/voter-23.png" />

</Aligner>

<Aligner center sx={{height: '50%', width: '50%'}}>

<Image src="/images/voter-24.png" />
