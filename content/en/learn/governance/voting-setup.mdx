...
Maker (MKR) token holders can set up a Voting Contract with either a single wallet or, for more security, a linked wallet.

With a linked wallet Voting Contract, users can vote from a hot wallet while their MKR remains stored on their cold wallet.
