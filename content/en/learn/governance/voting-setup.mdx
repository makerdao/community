...
Learn how to set up your digital wallet to participate in protecting the Maker Protocol's integrity through on-chain voting.
## Governance Polls

Recent upgrades to the Governance Portal make it easier to vote on Governance Polls. If you hold any MKR in your wallet, you can easily voice your opinion on a poll without setting up a voting contract. Governance polls are lower stakes. Poll outcomes don't immediately impact the protocol.
...
<Aligner center sx={{height: '100px', width: '65%'}}>
