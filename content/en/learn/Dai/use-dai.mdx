...
*Note*: Spending and using Dai means using a Dai-friendly wallet to store, send, and receive Dai, so make sure to brush up on [wallets](/learn/blockchain-fundamentals/wallets/).
