...
There are seemingly infinite ways you can customize page content, but try not to get carried away. These guidelines are meant to keep page content and component usage ** *visually* ** consistent across this site, which improves the overall user and reader experience.

Above all else, ** *be consistent,* ** and ** *when in doubt, keep it pure text.* **
