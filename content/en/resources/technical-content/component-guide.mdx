...
For a broader overview of all components, check out the [Component Palette](/resources/technical-content/palette-recipes). For more information about using components in MDX, read our other tutorials on [Crafting Technical Content](/develop/content).
