...
Vaults are not free to use and come with inherent risks. Generating Dai requires the payment of [Stability Fees](/faqs/stability-fee) (SF). The SF is a variable rate and is subject to change based on the decisions of MKR Token holders through [voting](/faqs/governance). To reclaim collateral, users must repay the previously generated Dai and the accumulated SF.

Vaults are required to be overcollateralized and have a [Liquidation Ratio](/faqs/liquidation) that Vault owners need to uphold to avoid the [Liquidation](/faqs/liquidation) of their Vaults. What a Vault is liquidated, a [Liquidation Penalty](/faqs/liquidation) is applied, and collateral is sold to repay the Vault's outstanding Dai balance. Additionally, a [Debt Ceiling](#what-is-a-debt-ceiling) is imposed globally on the Maker Protocol, as well as individually on each Vault type.

For more information, visit the [Vault FAQ](/faqs/vault).
...
![Oasis Choices](/images/assets/vault/2.png)
...
![Connect Wallet](/images/assets/vault/3.png)
![Connect Wallet Request](/images/assets/vault/4.png)
...
![Oasis Borrow Dashboard](/images/assets/vault/5.png)

The top right-hand panel displays information about the connected wallet, including token balances. The menu below lists information about the global state of Vaults and [the prices of relevant assets.](/faqs/oracles)

![Wallet Information Panel](/images/assets/vault/6.png)
![Global System Information Panel](/images/assets/vault/7.png)

### Opening a Vault

To open a new Vault, click “Get Started” on the dashboard.

![Get Started](/images/assets/vault/8.png)

Select a collateral type for this Vault. Make note of the information about the [Stability Fee](/faqs/stability-fee), [Liquidation Ratio](/faqs/liquidation#what-is-the-liquidation-ratio), and [Liquidation Penalty](/faqs/liquidation#what-is-the-liquidation-penalty). These are important risk parameters which you should understand as well as be able to apply to your specific situation. When ready, click “Continue.”

![Select a Collateral Type](/images/assets/vault/9.png)
...
![MetaMask Transaction Screen](/images/assets/vault/10.png)
...
![Vault Setup and Management](/images/assets/vault/11.png)
...
![Deposit ETH and Generate Dai](/images/assets/vault/12.png)
...
![Confirm Vault Details](/images/assets/vault/13.png)

Congratulations! The Vault is ready! Newly generated Dai will appear in the wallet.

![Congratulations!](/images/assets/vault/14.png)
...
![Oasis Vault Dashboard](/images/assets/vault/15.png)
...
![Oasis Vault Manager Dashboard](/images/assets/vault/16.png)
...
![Generate DAI](/images/assets/vault/17.png)

### Adding Collateral

Adding Collateral is useful in two scenarios. The first is when a Vault is coming close to being [liquidated](/faqs/liquidation), adding collateral can save the Vault. The second is when a Vault owner wants to increase their capacity for generating Dai, adding collateral will increase the maximum amount of Dai that can be generated.
...
![Payback DAI](/images/assets/vault/19.png)
...
![Withdraw Collateral](/images/assets/vault/20.png)
...
![Vault History](/images/assets/vault/21.png)
