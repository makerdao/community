...
* Anything that has a definition provided by MakerDAO. The capitalization is an indicator to the world that it's a special term.
  * See a list of these terms in the [Glossary of Terms](https://github.com/makerdao/community/tree/765a43a1c37988af55b31dfba6008bbb9a085f00/contributing/community/faqs/glossary.md)
...
* **Ensure the** [**SUMMARY.md**](https://github.com/makerdao/community/tree/765a43a1c37988af55b31dfba6008bbb9a085f00/SUMMARY.md) **file is updated for every document that should show up in GitBook.**
...
* Use descriptive hyperlinks. Avoid generic terms:
  * **No:** Learn more [here](https://github.com/makerdao/community/tree/765a43a1c37988af55b31dfba6008bbb9a085f00/contributing/link/README.md).
  * **Yes:** Learn more at [awesome-makerdao](https://github.com/makerdao/community/tree/765a43a1c37988af55b31dfba6008bbb9a085f00/contributing/link/README.md).
...
* Look for terms to add to the [Glossary](../makerdao-faqs/faqs/glossary.md).
