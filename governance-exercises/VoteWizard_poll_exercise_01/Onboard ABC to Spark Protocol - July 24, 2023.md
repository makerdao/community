...
Please review the proposal [thread](https://forum.makerdao.com/t/...) for more information about this proposed onboarding.

A risk evaluation has been provided by BA Labs and can be found [here](A link to the historic evaluation). 

## Outcomes

**If the votes for the 'Yes' option exceed the votes for the 'No' option then the following actions will be taken:**
* ABC will be onboarded to Spork Protocol in a future executive vote.
